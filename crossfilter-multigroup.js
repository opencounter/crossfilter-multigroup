 ...
 */
export default function Multigroup(dimension, groupValues) {
  if (!dimension || !dimension.group) {
    throw new TypeError("The first argument for multigroup must be a " +
      "Crossfilter dimension object.");
  }
  if (typeof groupValues !== "function") {
    throw new TypeError("The second argument for multigroup must be a " +
      "function that, given a record, returns an array of values to group by.");
  }
